all:merg_int.o quick_int.o heap_int.o merg_char.o quick_char.o heap_char.o
...
merg_char.o:merg_char.c dataset2.txt
	gcc merg_char.c -o mar
	cat dataset2.txt | ./mar
